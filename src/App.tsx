  ...
  return (
    <div className="landing-container">
      {!isSupabaseConfigured && (
        ...
        >
          <strong>Supabase 환경 변수가 없습니다.</strong>
          <br />
          프로젝트 루트에 <code style={{ background: '#fde68a', padding: '0 6px', borderRadius: '4px' }}>.env</code> 파일을 만들고{' '}
          <code style={{ background: '#fde68a', padding: '0 6px', borderRadius: '4px' }}>.env.example</code>을 참고해{' '}
          <code style={{ background: '#fde68a', padding: '0 6px', borderRadius: '4px' }}>VITE_SUPABASE_URL</code>,{' '}
          <code style={{ background: '#fde68a', padding: '0 6px', borderRadius: '4px' }}>VITE_SUPABASE_ANON_KEY</code>를 넣은 뒤{' '}
          개발 서버를 다시 시작하세요.
        </div>
      )}
